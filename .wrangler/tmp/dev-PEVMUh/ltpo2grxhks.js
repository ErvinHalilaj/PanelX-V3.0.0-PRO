...
// .wrangler/tmp/pages-Rw0Bin/bundledWorker-0.45022540003501965.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var L = /* @__PURE__ */ __name2((e, t, s) => (r, n) => {
  let i = -1;
  return a(0);
  async function a(d) {
...
var ue = Symbol();
var de = /* @__PURE__ */ __name2(async (e, t = /* @__PURE__ */ Object.create(null)) => {
...
var we = /* @__PURE__ */ __name2((e) => N(e, decodeURI), "we");
...
var q = /* @__PURE__ */ __name2((e, t, ...s) => (s.length && (t = q(t, ...s)), `${e?.[0] === "/" ? "" : "/"}${e}${t === "/" ? "" : `${e?.at(-1) === "/" ? "" : "/"}${t?.[0] === "/" ? t.slice(1) : t}`}`), "q");
...
var k = /* @__PURE__ */ __name2((e) => /[%+]/.test(e) ? (e.indexOf("+") !== -1 && (e = e.replace(/\+/g, " ")), e.indexOf("%") !== -1 ? N(e, G) : e) : e, "k");
var z = /* @__PURE__ */ __name2((e, t, s) => {
  let r;
  if (!s && t && !/[%+]/.test(t)) {
    let a = e.indexOf("?", 8);
    if (a === -1) return;
...
var ve = z;
var Re = /* @__PURE__ */ __name2((e, t) => z(e, t, true), "Re");
var G = decodeURIComponent;
var M = /* @__PURE__ */ __name2((e) => N(e, G), "M");
var Q = class {
  static {
    __name(this, "Q");
  }
...
var Ee = { Stringify: 1 };
var X = /* @__PURE__ */ __name2(async (e, t, s, r, n) => {
...
var D = /* @__PURE__ */ __name2((e, t) => ({ "Content-Type": e, ...t }), "D");
var xe = class {
  static {
    __name(this, "xe");
  }
  ...
  setLayout = /* @__PURE__ */ __name2((e) => this.#d = e, "setLayout");
  getLayout = /* @__PURE__ */ __name2(() => this.#d, "getLayout");
  ...
  body = /* @__PURE__ */ __name2((e, t, s) => this.#a(e, t, s), "body");
  text = /* @__PURE__ */ __name2((e, t, s) => !this.#o && !this.#i && !t && !s && !this.finalized ? new Response(e) : this.#a(e, t, D(qe, s)), "text");
  json = /* @__PURE__ */ __name2((e, t, s) => this.#a(JSON.stringify(e), t, D("application/json", s)), "json");
  html = /* @__PURE__ */ __name2((e, t, s) => {
    const r = /* @__PURE__ */ __name2((n) => this.#a(n, t, D("text/html; charset=UTF-8", s)), "r");
  ...
  notFound = /* @__PURE__ */ __name2(() => (this.#u ??= () => new Response(), this.#u(this)), "notFound");
};
var g = "ALL";
var Oe = "all";
...
var Ce = /* @__PURE__ */ __name2((e) => e.text("404 Not Found", 404), "Ce");
var F = /* @__PURE__ */ __name2((e, t) => {
  if ("getResponse" in e) {
...
var Ie = class Z {
  ...
  route(t, s) {
    ...
    return s.routes.map((n) => {
      let i;
      s.errorHandler === F ? i = n.handler : (i = /* @__PURE__ */ __name2(async (a, d) => (await L([], s.errorHandler)(a, () => n.handler(a, d))).res, "i"), i[Ae] = n.handler), r.#i(n.method, n.path, i);
    }), this;
  }
  basePath(t) {
    const s = this.#e();
  ...
  mount(t, s, r) {
    let n, i;
    r && (typeof r == "function" ? i = r : (i = r.optionHandler, r.replaceRequest === false ? n = /* @__PURE__ */ __name2((o) => o, "n") : n = r.replaceRequest));
    const a = i ? (o) => {
      const c = i(o);
    ...
    const d = /* @__PURE__ */ __name2(async (o, c) => {
  ...
  fetch = /* @__PURE__ */ __name2((t, ...s) => this.#r(t, s[1], s[0], t.method), "fetch");
  request = /* @__PURE__ */ __name2((t, s, r, n) => t instanceof Request ? this.fetch(s ? new Request(t, s) : t, r, n) : (t = t.toString(), this.fetch(new Request(/^https?:\/\//.test(t) ? t : `http://localhost${q("/", t)}`, s), r, n)), "request");
...
var ee = [];
function Se(e, t) {
  const s = this.buildAllMatchers(), r = /* @__PURE__ */ __name2(((n, i) => {
...
var Ge = /* @__PURE__ */ __name2(async (e) => {
...
__name(U, "U");
__name2(U, "U");
var Qe = /* @__PURE__ */ __name2((e = console.log) => async function(s, r) {
...
// .wrangler/tmp/pages-Rw0Bin/ltpo2grxhks.js
...
// .wrangler/tmp/bundle-86LMSM/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-86LMSM/middleware-loader.entry.ts
...
//# sourceMappingURL=ltpo2grxhks.js.map
